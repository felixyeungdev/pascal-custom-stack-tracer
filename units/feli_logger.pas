...
var line: ansiString;
begin
    line := format('[DEMO] %0:-10s %s', ['[Debug]', payload]);
    textColor(blue);
...
var line: ansiString;
begin
    line := format('[DEMO] %0:-10s %s', ['[Log]', payload]);
    textColor(mono);
    FeliLogger.save(line);
    textColor(mono);
end;
...
var line: ansiString;
begin
    line := format('[DEMO] %0:-10s %s', ['[Error]', payload]);
    textColor(lightRed);
    FeliLogger.save(line);
    textColor(mono);
end;
...
var line: ansiString;
begin
    line := format('[DEMO] %0:-10s %s', ['[Warn]', payload]);
    textColor(yellow);
    FeliLogger.save(line);
    textColor(mono);
end;
...
var line: ansiString;
begin
    line := format('[DEMO] %0:-10s %s', ['[Info]', payload]);
    textColor(lightBlue);
    FeliLogger.save(line);
    textColor(mono);
end;
...
var line: ansiString;
begin
    line := format('[DEMO] %0:-10s %s', ['[Success]', payload]);
